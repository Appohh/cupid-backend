package cupid.main.config.security;

import cupid.main.config.security.auth.AuthenticationRequestFilter;
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(registry ->
                        registry.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()                 // CORS pre-flight requests should be public
                                ...
                                .requestMatchers(HttpMethod.POST, "/user/createToken").permitAll()
                                .requestMatchers(HttpMethod.POST, "/user/validateToken").permitAll()
                                .requestMatchers(HttpMethod.GET, "/user/verificationStatus/{token}").permitAll()
                                .requestMatchers(HttpMethod.GET, "/analytics/generateDashboard").permitAll()
